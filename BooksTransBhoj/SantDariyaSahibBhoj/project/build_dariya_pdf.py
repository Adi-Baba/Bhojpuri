...
BASE_DIR = "/home/aditya/Documents/BhojPuriRevive/BooksTransBhoj/SantDariyaSahibBhoj"
PROJECT_DIR = os.path.join(BASE_DIR, "project")
TEX_DIR = os.path.join(PROJECT_DIR, "tex")
TEX_FILE = os.path.join(TEX_DIR, "dariya_sahib_bhojpuri.tex")
...
for filepath in files_to_include:
    ...
    for line in lines:
        ...
        if is_first_line:
            ...
            is_first_line = False
        elif line.startswith("१.") or line.startswith("२.") or line.startswith("३.") or line.startswith("---"):
            if line.startswith("---"):
...
try:
    cmd = ["lualatex", "-shell-escape", "-interaction=nonstopmode", "dariya_sahib_bhojpuri.tex"]
    for i in range(3):
    ...
    if res.returncode == 0:
        ...
        print("LuaLaTeX finished with status:", res.returncode)
